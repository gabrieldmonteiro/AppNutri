...
public class InputValidation {
    ...
    public boolean isInputEditTextFieldFilled(TextInputEditText textInputEditText, TextInputLayout textInputLayout, String message){
